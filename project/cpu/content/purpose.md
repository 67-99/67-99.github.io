...
到了大二，随着计算机系统2A的开设，我们系统性的学习了微处理器与汇编。在课程中有一项小组作业要求编写[Manchester Baby](https://en.wikipedia.org/wiki/Manchester_Baby)的汇编器与模拟器，于是我便提出了开发图灵完备中的“电脑”配套的logisim电路。